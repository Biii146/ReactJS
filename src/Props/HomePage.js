    ...
    render() {
        return (
            <div className="container">
                <div className="row">
                    <div className="col-4">
                        {/* the cha - dat ten sao cung dc */}
                        {/* Cách gọi theo class component */}
                            {/* c1: gán từng giá trị riêng lẻ */}
                                {/* <Product nameCar="Black Car" price={2000}/> */}
                            {/* C2: gán nguyên 1 đối tượng */}
                                {/* <Product product={this.productList[0]}/> */}
                        
                        {/* Cách gọi theo function component */}
                        <FunctionProduct product={this.productList[0]}/>


                    </div>
                    <div className="col-4">
                        {/* <Product nameCar="Red Car" price={1000}/> */}
                    ...
                    <div className="col-4">
                        {/* <Product nameCar="Silver Car" price={4000}/> */}
